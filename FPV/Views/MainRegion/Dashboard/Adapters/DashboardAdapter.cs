...
{
    /// <summary>
    /// Der DashboardAdapter stellt die im Projekt vorhandenen DashboardWidgets zur Verfügung.
    ...
    public class DashboardAdapter : AdapterBase
    {
        ...
        /// </summary>
        public static readonly DependencyProperty AddDashboardWidgetCommandProperty = DependencyProperty.Register("AddDashboardWidgetCommand", typeof(ActionCommand), typeof(DashboardAdapter),
            new PropertyMetadata(null));

        /// <summary>
        /// DependencyProperty für die <see cref="AvailableDashboardWidgets" />-Eigenschaft
        /// </summary>
        public static readonly DependencyProperty AvailableDashboardWidgetsProperty = DependencyProperty.Register("AvailableDashboardWidgets", typeof(ICollectionView),
            typeof(DashboardAdapter), new PropertyMetadata(null));

        /// <summary>
        /// DependencyProperty für die <see cref="SelectedDashboardWidget" />-Eigenschaft
        /// </summary>
        public static readonly DependencyProperty SelectedDashboardWidgetProperty = DependencyProperty.Register("SelectedDashboardWidget", typeof(IDashboardWidgetMetadata),
            typeof(DashboardAdapter), new PropertyMetadata(null, OnSelectedDashboardWidgetPropertyChanged));
