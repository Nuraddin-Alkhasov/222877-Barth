...
namespace HMI.Dashboard
{
    ...
    /// </summary>
    [ExportDashboardWidget("DB_Widget_KZT", "Dashboard.Text10", "@Dashboard.Text11", 1, 1)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class DB_Widget_KZT : View, INotifyPropertyChanged
    {
        ...
        public DB_Widget_KZT()
        {
            ...
            WM = VS.GetVariable("PLC.PLC.Blocks.5 Modul 3 Trockner.08 Heizung / Ventilatoren.04 Kühlzone.DB Kühlzone HMI.Istwerte.Temperatur");
