...
namespace HMI.Dashboard
{
    ...
    public partial class DB_Widget_VZT : View, INotifyPropertyChanged
    {
        ...
        public DB_Widget_VZT()
        {
            ...
            WM = VS.GetVariable("PLC.PLC.Blocks.5 Modul 3 Trockner.08 Heizung / Ventilatoren.01 Vorzone.DB Vorzone HMI.Istwerte.Temperatur");
