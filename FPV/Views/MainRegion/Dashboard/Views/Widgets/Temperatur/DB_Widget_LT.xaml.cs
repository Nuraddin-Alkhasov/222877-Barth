...
namespace HMI.Dashboard
{
    ...
    public partial class DB_Widget_LT : View, INotifyPropertyChanged
    {
        ...
        public DB_Widget_LT()
        {
            ...
            WM = VS.GetVariable("PLC.PLC.Blocks.4 Modul 2 Beschichtung.05 Tauchbecken.DB LTB HMI.Actual value.Dipping Vat.LTB Temperatur");
