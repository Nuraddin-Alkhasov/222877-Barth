...
namespace HMI.Views.MainRegion.Recipe
{
    ...
    [ExportAdapter("RecipeAdapter_D")]
    public class RecipeAdapter_D : AdapterBase
    {
        public IRecipeClass recipeClass;
        private ObservableCollection<RecipeFileInfo> recipeFiles;

        public RecipeAdapter_D()
        {
            this.recipeClass = ApplicationService.GetService<IRecipeService>().GetRecipeClass("D");
