...
namespace HMI.Views.MainRegion.Recipe
{
    ...
    [ExportAdapter("RecipeAdapter_R")]
    public class RecipeAdapter_R : AdapterBase
    {
        public IRecipeClass recipeClass;
        private ObservableCollection<RecipeFileInfo> recipeFiles;

        public RecipeAdapter_R()
        {
            this.recipeClass = ApplicationService.GetService<IRecipeService>().GetRecipeClass("R");
