...
namespace HMI.Handmenu.Manipulator
{
    ...
    /// </summary>
    [ExportView("H_M_Rotate_Service")]

    public partial class H_M_Rotate_Service : View
    {
        private readonly ILoggingService loggingService;

        public H_M_Rotate_Service()
        {
        ...
        private void Button_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            {
                ApplicationService.SetVariableValue("PLC.PLC.Blocks.3 Modul 1 ZF MA Auskippen.08 Manipulator.02 Mani Drehen.DB Mani Drehen HMI.PC.Drive.Vorwahl Referenz", 1);
