...
namespace HMI.Handmenu.Drayer
{
    ...
    /// </summary>
    [ExportView("H_D_HVT_PS_PN")]
    public partial class H_D_HVT_PS_PN : View
    {
		
        public H_D_HVT_PS_PN()
        {
