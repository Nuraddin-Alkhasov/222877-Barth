...
namespace HMI.Handmenu.Drayer
{
    ...
    /// </summary>
    [ExportView("H_D_CT_TAA_PN")]
    public partial class H_D_CT_TAA_PN : View
    {
		
        public H_D_CT_TAA_PN()
        {
