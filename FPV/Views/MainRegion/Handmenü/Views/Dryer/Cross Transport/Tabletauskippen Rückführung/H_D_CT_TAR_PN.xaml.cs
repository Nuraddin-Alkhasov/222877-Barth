...
namespace HMI.Handmenu.Drayer
{
    ...
    /// </summary>
    [ExportView("H_D_CT_TAR_PN")]
    public partial class H_D_CT_TAR_PN : View
    {
		
        public H_D_CT_TAR_PN()
        {
