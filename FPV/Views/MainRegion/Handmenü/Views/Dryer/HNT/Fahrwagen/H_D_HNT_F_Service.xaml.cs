...
namespace HMI.Handmenu.Drayer
{
    ...
    /// </summary>
    [ExportView("H_D_HNT_F_Service")]

    public partial class H_D_HNT_F_Service : View
    {
        private readonly VisiWin.Logging.ILoggingService loggingService;

        public H_D_HNT_F_Service()
        {
        ...
        private void Key_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            {
                ApplicationService.SetVariableValue("PLC.PLC.Blocks.5 Modul 3 Trockner.04 HNT.02 Fahrawagen.02 Fahrantrieb.DB HNT Fahrwagen HMI.PC.Drive.Vorwahl Referenz", 1);
                ILanguageService textService = ApplicationService.GetService<ILanguageService>();

                string txt = textService.GetText("@Logging.Service.Text14");
