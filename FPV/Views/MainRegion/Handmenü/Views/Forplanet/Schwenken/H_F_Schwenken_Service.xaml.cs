...
namespace HMI.Handemnu.Forplanet
{
    ...
    /// </summary>
    [ExportView("H_F_Schwenken_Service")]
    public partial class H_F_Schwenken_Service : View
    {
        private readonly ILoggingService loggingService;

        public H_F_Schwenken_Service()
        {
        ...
        private void Button_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            {
                ApplicationService.SetVariableValue("PLC.PLC.Blocks.4 Modul 2 Beschichtung.15 Schwenken.DB BS Schwenken HMI.PC.Drive.Vorwahl Referenz", 1);
