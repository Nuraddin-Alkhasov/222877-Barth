...
//
//	FUNKTION:
//	Adapter zum Verwalten von historischen Logbucheinträgen
//
//
//	Befehle 
//	----------------------------------------------------------------------------
//	ShowRequestLoggingEntriesDialog		--> zeigt den Filterdialog für historische Logbucheinträge
//
//
//	Bindungsmöglichkeiten
//	-----------------------------------------------------------------------------
//	LoggingEntries						--> Auflistung der ermittelten Logbucheinträge
//	LoggingFilter						--> Filtereinstellungen, die beim Ermitteln der Logbucheinträge angewendet werden
//	IsRequestingLoggingEntries			--> zeigt an, dass im Moment eine Abfrage aktiv ist
//	CanRequestLoggingEntries			--> zeigt an, ob eine neue Abfrage gestartet werden kann.
//
//
//	notwendige Dateien: 
//	-----------------------------------------------------------------------------
//	LoggingAdapter.cs					--> dieser Adapter
//	LoggingView.xaml(.cs)				-->	Anzeige der ermittelten Alarme
