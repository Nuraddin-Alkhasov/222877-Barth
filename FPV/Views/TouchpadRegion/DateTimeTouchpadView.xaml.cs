...
namespace HMI
{
    ...
    public partial class DateTimeTouchpadView : VisiWin.Controls.View
    {
        ...
        private bool milliSecondInputVisible;
        ...
        {            
            ...
            milliSecondInputVisible = timeFormatString.Contains("f") || timeFormatString.Contains("F");
        ...
        private void WriteInputValue()
        {
            if (selectedDateTimeVarIn != null)
            {
				...
				selectedDateTimeVarIn.StopEdit(true);
            }
        }
